"""Generate realistic synthetic wildfire hotspot data for Chiang Mai province.

This script generates monthly satellite-derived environmental data from 2015-2024,
simulating realistic seasonal patterns for wildfire prediction in Northern Thailand.
"""
...
def generate_sample_data(output_path: str = "data/sample_hotspot_data.csv") -> pd.DataFrame:
    """Generate synthetic wildfire hotspot dataset with realistic seasonal patterns.
    ...
    # Year-to-year severity multiplier (some years are worse)
    year_severity = {
    ...
    # --- Hotspot count ---
    # Peak in Feb-Apr (Thai burning season)
    ...
    # --- NDVI (inversely correlated with hotspot) ---
    ndvi_base = {
